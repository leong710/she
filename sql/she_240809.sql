...
CREATE TABLE `_shlocal` (
  ...
  `HE_CATE` longtext NOT NULL COMMENT '預防職業病健康檢查類別',
  `AVG_VOL` varchar(10) DEFAULT NULL COMMENT '均能音量',
  `AVG_8HR` varchar(10) DEFAULT NULL COMMENT '工作日8小時平均音壓值',
  `MONIT_NO` varchar(20) NOT NULL COMMENT '監測編號',
  `MONIT_LOCAL` varchar(50) NOT NULL COMMENT '監測處所',
  `WORK_DESC` varchar(256) NOT NULL COMMENT '作業描述',
  `flag` varchar(5) NOT NULL COMMENT '開關',
  `created_at` datetime NOT NULL COMMENT '創建時間',
  `updated_at` datetime NOT NULL COMMENT '更新時間',
...
INSERT INTO `_shlocal` (`id`, `OSHORT`, `OSTEXT_30`, `OSTEXT`, `HE_CATE`, `AVG_VOL`, `AVG_8HR`, `MONIT_NO`, `MONIT_LOCAL`, `WORK_DESC`, `flag`, `created_at`, `updated_at`, `updated_cname`) VALUES
(8, '9K111504', 'T6', 'CF黃光課', '鎳作業', '', '', 'S25258', 'CFCT01-02', '更換CFCT(彩色濾光片製程)所需的含鎳的光阻桶 ', 'On', '2024-08-09 16:58:12', '2024-08-09 16:58:12', '陳建良'),
(9, '9T522503 ', 'FAB8', '設備保養課', '噪音作業,銦作業', '92', '', 'C13861', 'TFT_L20E54', '執行TFT(薄膜電晶體陣列製程)機台的銦靶材研磨作業(在噪音區)', 'On', '2024-08-09 16:58:12', '2024-08-09 16:58:12', '陳建良'),
(10, '9T952501', 'FAB8棟', '空調課', '噪音', '', '87', 'FP862', 'FAC８_L30', '於FAC(廠務)空壓機房(噪音區)進行巡查點檢', 'On', '2024-08-09 16:58:12', '2024-08-09 16:59:24', '陳建良'),
(11, '9T042501', 'TAC棟', '工安衛一課', '噪音', '95', '87', 'noise_check', 'Off1ce 1F', '辦公室作業', 'On', '2024-08-09 16:58:12', '2024-08-09 17:00:39', '陳建良'),
(12, '9T952501', 'FAB8', '空調課', '噪音作業', '95', '', 'FP862', 'FAC８_M25', '於FAC(廠務)空壓機房(噪音區)進行巡查點檢', 'On', '2024-08-09 16:58:12', '2024-08-09 16:58:12', '陳建良'),
(13, '9T521502', 'FAB8', '曝光課', '游離輻射作業', '', '', '不適用', 'Array1', '保養Array(陣列製程)輻射設備', 'On', '2024-08-09 16:58:12', '2024-08-09 16:58:12', '陳建良');
...
--
ALTER TABLE `_users`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ai', AUTO_INCREMENT=4;
COMMIT;
