                    ...
                    <div id="nav-p2_table" class="tab-pane fade" role="tabpanel" aria-labelledby="nav-p2-tab">
                        <div class="col-12 bg-white">
                            ...
                            <div class="row">
                                ...
                                <!-- L2：右側function -->
                                <div class="col-8 col-md-9 py-0 text-end" id="form_btn_div">
                            ...
                            <table id="hrdb_table" class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th data-toggle="tooltip" data-placement="bottom" title="AVG_VOL"             style="width: 50px;">A權音壓級 <sup>(dBA)</sup></th>
                                        <th data-toggle="tooltip" data-placement="bottom" title="AVG_8HR 工作日8小時"  style="width: 50px;">日時量平均 <sup>(dBA)</sup></th>
                                        ...
                                        <th title="shCondition" <?php echo ($sys_role <= '2.2') ? "":"class='unblock'";?>><i class="fa-regular fa-square-check"></i>&nbsp;特檢資格</th>
                    ...
                    <table id="shCase_table" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th title="AVG_8HR 工作日8小時" >日時量平均<br><sup>(dBA)</sup></th>
